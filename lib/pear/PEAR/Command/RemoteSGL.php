 ...
 */
class PEAR_Command_RemoteSGL extends PEAR_Command_Common
{
    // {{{ command definitions

    var $commands = array(
        'sgl-remote-info' => array(
            'summary' => 'Information About Remote Packages',
            'function' => 'doRemoteInfoSGL',
            'shortcut' => 'x1',
            'options' => array(),
            'doc' => '<package>
Get details on a package from the server.',
            ),
        'sgl-list-upgrades' => array(
            'summary' => 'List Available Upgrades',
            'function' => 'doListUpgradesSGL',
            'shortcut' => 'x2',
            'options' => array(),
            'doc' => '[preferred_state]
...
or the state passed as the second parameter.'
        ...
        'sgl-remote-list' => array(
            'summary' => 'List Remote Packages',
            'function' => 'doRemoteListSGL',
            'shortcut' => 'x3',
            'options' => array(
                'channel' =>
                    array(
...
version of DB is 1.6.5, the downloaded file will be DB-1.6.5.tgz.',
        ...
        'sgl-clear-cache' => array(
            'summary' => 'Clear Web Services Cache',
            'function' => 'doClearCacheSGL',
            'shortcut' => 'x7',
            'options' => array(),
            'doc' => '
...
',
    ...
    function doRemoteInfoSGL($command, $options, $params)
    {
        if (sizeof($params) != 1) {
    ...
    function doRemoteListSGL($command, $options, $params)
    {
        $savechannel = $channel = $this->config->get('default_channel');
        $reg = &$this->config->getRegistry();
    ...
    function doListAllSGL($command, $options, $params)
    {
        $savechannel = $channel = $this->config->get('default_channel');
        $reg = &$this->config->getRegistry();
        if (isset($options['channel'])) {
    ...
    function doSearchSGL($command, $options, $params)
    {
    ...
    function doDownloadSGL($command, $options, $params)
    {
    ...
    function doListUpgradesSGL($command, $options, $params)
    {
    ...
    function doClearCacheSGL($command, $options, $params)
    {
