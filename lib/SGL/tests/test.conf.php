...
$conf['site']['sessionMaxLifetime'] = '0';
...
$conf['site']['urlHandler'] = 'SGL_UrlParser_SefStrategy';
$conf['site']['sessionHandler'] = 'file';
$conf['site']['extended_session'] = '0';
$conf['site']['single_user'] = '0';
...
$conf['p3p']['policies'] = '1';
$conf['p3p']['policy_location'] = '';
$conf['p3p']['compact_policy'] = 'CUR ADM OUR NOR STA NID';
