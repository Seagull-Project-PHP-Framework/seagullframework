...
$words['Reset password info'] = 'Sei stati azzerando la password per l\'utente amministratore, controlla la correttezza dell'indirizzo email al quale sara` spedita la nuova password e cheil tuo sistema sia correttamente configurato per spedire e ricevere email.';
