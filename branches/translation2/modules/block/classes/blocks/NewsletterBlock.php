        ...
        if ($this->username) {
            ...
            if ($subscribedLists) {
                ...
                foreach ($subscribedLists as $k => $v) {
                    ...
                    $subscribedNewsLists .= '<strong>'. $v->list .'</strong> (<a href="'. SGL_Url::makeLink('unsubscribe', 'newsletter', 'newsletter') .'frmListName[]/'. $this->listID .'/frmUserID/'. $this->userID . '">unsubscribe</a>)<br />';
                }
