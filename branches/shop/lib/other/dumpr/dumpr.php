 ...
 *     Revision 1.8
 *         + Added $sort parameter to dumpr. It will sort the keys if not omitted. It defaults to false.
 *         + Added 3 new functions in the dumpr.php file:
 *           1) dumprc - dump constants matching $mask or all constants if $mask is null. Sorting defaults to true (opposite of dumpr)
 *              ex. dumprc('_') - dump constants starting with '_' and sort keys alphabetically (default; opposite of dumpr)
 *              ex. dumprc('_', false) - dump constants starting with '_' and disables key sorting
 *           2) dumprg - dump global variables matching $mask or all global variables if $mask is null. Sorting defaults to true (opposite of dumpr)
 *              ex. dumprg('_') - dump global variables starting with '_' and sort keys alphabetically (default; opposite of dumpr)
 *              ex. dumprg('_', false) - dump global variables starting with '_' and disables key sorting
 *           3) dumprx - dump data matching $mask or complete array if $mask is null. Sorting defaults to true (opposite of dumpr default)
 *              ex. dumprx($myData, '_') - dump $myData where keys start with '_' and sort keys alphabetically (default; opposite of dumpr)
 *              ex. dumprx($myData, '_', false) - dump $myData where keys start with '_' and disables key sorting
 */
