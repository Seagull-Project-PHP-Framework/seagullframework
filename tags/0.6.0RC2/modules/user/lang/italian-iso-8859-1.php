...
$words['Reset password info'] = 'Sei stati azzerando la password per l\'utente amministratore, controlla la correttezza dell\'indirizzo email al quale sara` spedita la nuova password e che il tuo sistema sia correttamente configurato per spedire e ricevere email.';
$words['return to browse'] = 'ritorna all\'elenco';
$words['back to Account'] = 'ritorna all\'account';
$words['change password'] = 'cambia password';
$words['This email already exist in the DB, please choose another'] = 'Questa email e` gia` utilizzata da un altro utente, per favore scegline un\'altra';
$words['This username already exist in the DB, please choose another'] = 'Questo username e` gia` utilizzato da un altro utente, per favore scegline un altro.';
...
$words['You have entered your original password incorrectly'] = 'La password originale non e` corretta';
...
$words['You must enter your city'] = 'Manca la citta`';
...
$words['Dear'] = 'Spett.le';
$words['You are being sent this email because you just registered, your logon details are as follows'] = 'Ti e` stata spedita questa email perche` ti sei registrato, i tuoi dati per accedere al sito sono i seguenti';
...
$words['You are being sent this email because'] = 'Ti e` stata spedita questa email perche` hai richiesto di ripristinare la password.';
$words['Your new password is'] = 'la tua nuova password e`';
...
$words['Logins'] = 'Logins';
$words['You are being sent this email because your new account status is now'] = 'Ti viene spedita questa email perche` il nuovo stato del tuo account e` ora';
$words['active'] = 'attivo';
$words['disabled'] = 'non attivo';
$words['Changing status for'] = 'Cambia lo stato per';
$words['Current status is'] = 'Lo stato attuale e`';
