...
INSERT INTO permission VALUES ({SGL_NEXT_ID}, 'contactusmgr_send', 'Permission to submit contact info', (SELECT MAX(module_id) FROM module));
INSERT INTO permission VALUES ({SGL_NEXT_ID}, 'contactusmgr_list', 'Permission to view Contact Us screen', (SELECT MAX(module_id) FROM module));
...
INSERT INTO role_permission VALUES ({SGL_NEXT_ID}, 2, (SELECT permission_id FROM permission WHERE name = 'contactusmgr_list'));
INSERT INTO role_permission VALUES ({SGL_NEXT_ID}, 2, (SELECT permission_id FROM permission WHERE name = 'contactusmgr_send'));