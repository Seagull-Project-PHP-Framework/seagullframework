...
$words['username min length'] = 'Your username must be alphanumeric with at least 5 characters and no spaces';
...
$words['to enable the new users account'] = 'to enable the new user\'s account';
...
$words['Organisation list'] = 'Organisation list';
$words['New organisation'] = 'New organisation';
$words['Edit organisation'] = 'Edit organisation';
$words['groups'] = 'groups';
$words['Group'] = 'Group';
...
$words['The selected organisation cannot be deleted because there are users relating to it'] = 'The selected organisation %s cannot be deleted because there are users relating to it!';
...
$words['Name'] = 'Name';
$words['Description'] = 'Description';
$words['You must enter a role name'] = 'You must enter a role name';
...
/* User Import*/
$words['OrgType Manager'] = 'Organisation Type Manager';
$words['OrgType Manager :: Add'] = 'Organisation Type Manager :: Add';
$words['OrgType Manager :: Edit'] = 'Organisation Type Manager :: Edit';
$words['Organisation Type list'] = 'Organisation Type list';
...
$words['New permission'] = 'New permission';
$words['Editing permission'] = 'Editing permission';
$words['New Role'] = 'New Role';
$words['Editing role'] = 'Editing role';
$words['Changing permission assignments for'] = 'Changing permission assignments for';
$words['Role name'] = 'Role name';
$words['permissions'] = 'permissions';
$words['Remaining permissions'] = 'Remaining permissions';
$words['Selected permissions for'] = 'Selected permissions for';
$words['New preference'] = 'New preference';
$words['Editing preference'] = 'Editing preference';
$words['Enable user'] = 'Enable user';
$words['Disable user'] = 'Disable user';
$words['Synchronise'] = 'Synchronise';
$words['Organisation name'] = 'Organisation name';
$words['edit user'] = 'edit user';
$words['Connections list for user'] = 'Connections\'s list for user';
$words['With selected record(s)'] = 'With selected record(s)';
$words['Permissions for user'] = 'Permissions for user';
$words['User list'] = 'User list';
$words['No users found'] = 'No users found';
$words['Reset password info'] = 'Remember, if you\'re resetting the password for the admin user, make sure you correctly specify the email address the new password will go to (hit "edit" for the admin user), and that your system is correctly setup to send and receive email.';
$words['Change status'] = 'Change status';
$words['Select a module'] = 'Select a module';
