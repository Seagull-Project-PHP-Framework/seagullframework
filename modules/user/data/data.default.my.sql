...
INSERT INTO permission VALUES ({SGL_NEXT_ID}, 'passwordmgr_cmd_edit', '', @moduleId);
INSERT INTO permission VALUES ({SGL_NEXT_ID}, 'passwordmgr_cmd_update', '', @moduleId);
...
INSERT INTO role_permission VALUES ({SGL_NEXT_ID}, 2, @permissionId);
SELECT @permissionId := permission_id FROM permission WHERE name = 'passwordmgr_cmd_edit';
INSERT INTO role_permission VALUES ({SGL_NEXT_ID}, 2, @permissionId);
SELECT @permissionId := permission_id FROM permission WHERE name = 'passwordmgr_cmd_redirectToEdit';
INSERT INTO role_permission VALUES ({SGL_NEXT_ID}, 2, @permissionId);
SELECT @permissionId := permission_id FROM permission WHERE name = 'passwordmgr_cmd_update';
INSERT INTO role_permission VALUES ({SGL_NEXT_ID}, 2, @permissionId);
